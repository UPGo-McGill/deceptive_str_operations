...
ggsave(here("output", "figures", "no_face_avg.png"), plot = no_face_avg, width = 7, 
       height = 4, units = "in")
...
We found that reviews let to commercial operators were less likely to contain the name of the hosts. Indeed, we separated commercial operations from non-commercial and look on an aggregated level. Commercial operators have only a fifth (`r commercial_name_mention[2,2]`) of their reviews which contain the name of the host, while for non-commercial operators, as much as half (`r commercial_name_mention[1,2]`) of the reviews includes it. 
